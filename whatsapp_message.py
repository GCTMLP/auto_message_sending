...
def send_message_wtsp(desire_caps, socket, tel, mes):
    ...
    try:
        ...
        wd.find_elements_by_id('com.whatsapp:id/contactpicker_row_name')[1].click()
        wd.find_elements_by_class_name('android.widget.EditText')[0].send_keys('1')
        wd.find_elements_by_class_name('android.widget.EditText')[2].send_keys(tel)
        wd.find_element_by_id('com.android.contacts:id/editor_menu_save_button').click()
        wd.back()
        wd.find_elements_by_id('com.whatsapp:id/contactpicker_row_name')[2].click()
        ...
        wd.find_elements_by_class_name('android.widget.RelativeLayout')[2].click()
        wd.find_elements_by_id('com.google.android.dialer:id/contact_name')[1].click()
        wd.find_element_by_class_name('android.widget.ImageButton').click()
...
def main():
    ...
    tel = '79999999999'
    mes = 'hello'
    send_message_wtsp(desire_caps, socket, tel, mes)
